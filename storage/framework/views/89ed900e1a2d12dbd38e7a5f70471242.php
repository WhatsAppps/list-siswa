                                            ...
                                            <form class="px-8 pt-6 pb-8 mb-4 bg-white rounded"
                                                ...
                                                <div class="mb-4 md:flex md:justify-between">
                                                    <div class="mb-100 md:mr-2 md:mb-0">
                                                        ...
                                                        <input
                                                            ...
                                                            placeholder="<?php echo e($siswa->firstname); ?>" />
                                                    </div>
                                                    <div class="md-200:ml-2">
                                                        ...
                                                        <input
                                                            ...
                                                            placeholder="<?php echo e($siswa->lastname); ?>"
                                                ...
                                                <div class="mb-100">
                                                    ...
                                                    <input
                                                        ...
                                                        name="nama" type="text" placeholder="<?php echo e($siswa->nama); ?>"
                                                ...
                                                <div class="mb-100">
                                                    ...
                                                    <input
                                                        class="w-full px-3 py-2 mb-3 text-sm leading-tight text-gray-700 border rounded shadow appearance-none focus:outline-none focus:shadow-outline"
                                                        name="email" type="email" placeholder="<?php echo e($siswa->email); ?>"
                                                ...
                                                <div class="mb-400 md:flex md:justify-between">
                                                    <div class="mb-100 md:mr-2 md:mb-0">
                                                        ...
                                                        <input
                                                            ...
                                                            placeholder="<?php echo e($siswa->kelas); ?>"
                                                    ...
                                                    <div class="md:ml-2">
                                                        ...
                                                        <input
                                                            class="w-full px-3 py-2 mb-3 text-sm leading-tight text-gray-700 border rounded shadow appearance-none focus:outline-none focus:shadow-outline"
                                                            name="nis" type="text"
                                                            placeholder="<?php echo e($siswa->nis); ?>" />
                                                    </div>
                                                </div>
                                                <div class="mb-100">
                                                    <label class="block mb-2 text-sm font-bold text-gray-700">
                                                    ...
                                                    <input
                                                        ...
                                                        placeholder="<?php echo e($siswa->jurusan); ?>"
                                                ...
                                                <div class="mb-4 md:flex md:justify-between">
                                                    <div class="mb-100 md:mr-2 md:mb-0">
                                                        ...
                                                        <input
                                                            ...
                                                            placeholder="<?php echo e($siswa->alamat); ?>"
                                                    ...
                                                    <div class="md-200:ml-2">
                                                        ...
                                                        <input
                                                            class="w-full px-3 py-2 mb-3 text-sm leading-tight text-gray-700 border rounded shadow appearance-none focus:outline-none focus:shadow-outline"
                                                            name="ttl" type="date"
                                                            placeholder="<?php echo e($siswa->ttl); ?>"
                                                ...
                                                <div class="mb-4">
                                                    ...
                                                    <input
                                                        ...
                                                        placeholder="<?php echo e($siswa->mobile); ?>"
...
<?php /**PATH C:\Users\USER\rey\siswa\resources\views/list/edit.blade.php ENDPATH**/ ?>